    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <p>
                ...
                just let the <code>DictionaryForm->process()</code> <a href="https://github.com/xerxes333/Dictionary/blob/master/models/DictionaryForm.php#L54" target="_new">(link)</a> method handle the calculations.
