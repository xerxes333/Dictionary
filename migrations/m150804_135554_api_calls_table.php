...
class m150804_135554_api_calls_table extends Migration
{
    public function up()
    {
        ...
        $this->insert('wiw_api_call', [
            ...
            'action'=> "emp_summary",
            'method'=> "GET",
            'url'   => "/shifts/weeklysummary?user_id=3",
        ]);
        ...
        $this->insert('wiw_api_call', [
            ...
            'action'=> "mgr_shifts",
            'method'=> "GET",
            'url'   => "/shifts?user_id=11&start_time=2015-08-02 00:00:00&end_time=2015-08-03 23:59:59",
        ]);
